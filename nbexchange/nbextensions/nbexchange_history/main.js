define([
    ...
    var history_html = $([
        ...
        '    <strong>Info!</strong> As a student, you will only see your current course.',
        '       \nAs an instructor, you will see all the courses you are an instructor on',
        '       \nAs an admin, you will see all courses.',
        '    </div>',
