...
def test_list_normal(plugin_config, tmpdir):
    ...
    def api_request(*args, **kwargs):
        assert args[0] == (
            f"assignments?course_id=no_course"
        )
    ...
    with patch.object(Exchange, "api_request", side_effect=api_request):
        called = plugin.start()
        assert called == [{'assignment_id': 'assign_1_1',
                           'course_id': 'no_course',
                           'student_id': '1',
                           'status': 'released',
                           'notebooks': [{'feedback_timestamp': False,
                                          'feedback_updated': False,
                                          'has_exchange_feedback': False,
                                          'name': 'assignment-0.6'}],
                           'path': '',
            ...
            assert called == [{'assignment_id': 'assign_1_1',
                              ...
                              {'assignment_id': 'assign_1_3',
                               ...
                               'notebooks': [{
                                              ...
                                              "path": '/home/lkihlman/projects/edina/naas/nbexchange-examples/nbexchange_code/assign_1_3/assignment-0.6.ipynb'}],
                               'path': '',
                               'timestamp': '2020-01-01 00:00.2 UTC'}
                              ]
    finally:
        ...
        try:
            ...
            def api_request(*args, **kwargs):
                ...
                return type("Request", (object,),
                            {"status_code": 200, "json": (lambda: {"success": True, "value": [{
                                "assignment_id": "assign_1_1",
                                "student_id": "1",
                                "course_id": "no_course",
                                "status": "released",
...
def test_list_delete(plugin_config, tmpdir):
    ...
    def api_request(*args, **kwargs):
        assert args[0] == (
            f"assignment?course_id=no_course&assignment_id=assign_1_1"
        )
...
def test_list_inbound_one(plugin_config, tmpdir):
    ...
    with patch.object(Exchange, "api_request", side_effect=api_request):
        ...
        assert called == [{'assignment_id': 'assign_1_1',
                           ...
                           'student_id': '1',
                           'status': 'submitted',
                           'submissions': [{'assignment_id': 'assign_1_1',
                                            'course_id': 'no_course',
                                            'feedback_updated': False,
                                            'has_exchange_feedback': False,
                                            'has_local_feedback': False,
    ...
    with patch.object(Exchange, "api_request", side_effect=api_request):
        ...
        assert called == [{'assignment_id': 'assign_1_1',
                          ...
                          {'assignment_id': 'assign_1_2',
                           ...
                           'student_id': '2',
                           'status': 'submitted',
                           'submissions': [{'assignment_id': 'assign_1_2',
                                            'course_id': 'no_course',
                                            'feedback_updated': False,
                                            'has_exchange_feedback': False,
                                            'has_local_feedback': False,
