...
def test_list_feedback_available(plugin_config, tmpdir):
    try:
        ...
        my_feedback_dir = (
            f"{assignment_id}/feedback/2020-01-01%2000%3A02%3A00.2%2000%3A00"
        )
...
def test_list_feedback_available_with_path_includes_course(plugin_config, tmpdir):
    try:
        ...
        my_feedback_dir = f"{course_code}/{assignment_id}/feedback/2020-01-01%2000%3A02%3A00.2%2000%3A00"
        os.makedirs(my_feedback_dir, exist_ok=True)
        copyfile(
            feedback1_filename,
            os.path.join(
